"""
Django settings for late_feather_dev_99519 project.
...
ROOT_URLCONF = 'late_feather_dev_99519.urls'
...
WSGI_APPLICATION = 'late_feather_dev_99519.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "late_feather_dev_99519 API",
    "DESCRIPTION": "API documentation for late_feather_dev_99519 App",
    "VERSION": "v1",
}
